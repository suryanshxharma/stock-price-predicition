...
This project demonstrates a production-grade machine learning forecasting system. It implements a comparative benchmarking framework where deep learning sequential models (LSTM, GRU) are evaluated against classical baselines (Linear Regression, Random Forest) using a 21-feature technical indicator dataset and sliding window sequence representations.
